...
struct ModeConfig {
  ...
  bool mass_matrix_projection = false;
};
...
class ModeTables {
 public:
  ...
  bool MassMatrixProjectionEnabled() const { return config_.mass_matrix_projection; }
