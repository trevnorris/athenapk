...
Real ResponseW0LocalGradAbsHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/response_w0_local_grad_abs");
}
...
Real ResponseLambdaDynamicMixAAbsAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_response_lambda_dynamic_mix_a_abs");
}

Real ResponseLambdaDynamicMixPiAbsAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_response_lambda_dynamic_mix_pi_abs");
}
...
Real AwMode1GradzPowerMixW0LocalGradientDiscreteAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>(
      "diag/int_aw_mode1_gradz_power_mix_w0_local_gradient_discrete");
}

Real AwMode1GradzPowerMixW0LocalDzDiscreteAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_mode1_gradz_power_mix_w0_local_dz_discrete");
}

Real AwMode1GradzPowerPiDriveDiscreteAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
...
Real AwMode0GradzEnergyDeltaQuadraticDiscreteAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_mode0_gradz_energy_delta_quadratic_discrete");
}
...
Real AwMode1GradzEnergyDeltaExactDiscreteAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_mode1_gradz_energy_delta_exact_discrete");
}

Real AwMode1GradzEnergyDeltaQuadraticDiscreteAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_mode1_gradz_energy_delta_quadratic_discrete");
}
...
Real AwMode2GradzPowerMixW0LocalGradientDiscreteAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>(
      "diag/int_aw_mode2_gradz_power_mix_w0_local_gradient_discrete");
}

Real AwMode2GradzPowerMixW0LocalDzDiscreteAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_mode2_gradz_power_mix_w0_local_dz_discrete");
}

Real AwMode2GradzPowerPiDriveDiscreteAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_mode2_gradz_power_pi_drive_discrete");
}
...
Real AwMode2GradzEnergyDeltaQuadraticDiscreteAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_mode2_gradz_energy_delta_quadratic_discrete");
}
...
Real AwGradxPowerPiDriveDiscreteSumAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_gradx_power_pi_drive_discrete_sum");
}

Real AwGradzPowerPiDriveDiscreteSumAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_gradz_power_pi_drive_discrete_sum");
}

Real AwGradxEnergyDeltaExactDiscreteSumAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_gradx_energy_delta_exact_discrete_sum");
}
...
Real AwGradxWorkExactNodeSumAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_gradx_work_exact_node_sum");
}

Real AwGradzWorkExactNodeSumAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_gradz_work_exact_node_sum");
}
...
Real AwGradzPowerMixW0LocalGradientDiscreteSumAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_gradz_power_mix_w0_local_gradient_discrete_sum");
}

Real AwMode3GradzEnergyDeltaExactDiscreteAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_mode3_gradz_energy_delta_exact_discrete");
}

Real AwMode3GradzEnergyDeltaQuadraticDiscreteAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  return pkg->Param<double>("diag/int_aw_mode3_gradz_energy_delta_quadratic_discrete");
}
...
Real BulkEMEnergyLegacyIntegral(MeshData<Real> *md) {
  auto modes_pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  const int n_modes = modes_pkg->Param<int>("n_modes");
  const auto &tables = modes_pkg->Param<ModeTables>("mode_tables");
  const int n_quad = tables.NumQuadrature();
...
Real BulkEMEnergyZBlockCorrectionAccumulatorHst(MeshData<Real> *md) {
  auto pkg = md->GetBlockData(0)->GetBlockPointer()->packages.Get("modes4d");
  const Real coeff = pkg->Param<double>("em4d/bulk_energy_zblock_correction_coeff");
  if (coeff == 0.0) {
    return 0.0;
  }
  const Real cz_exact =
      pkg->Param<double>("diag/int_cz_energy_delta_exact_discrete_sum");
  const Real aw_dz_work =
      pkg->Param<double>("diag/int_aw_mode0_gradz_power_da_dt_discrete") +
      pkg->Param<double>("diag/int_aw_mode1_gradz_power_da_dt_discrete") +
      pkg->Param<double>("diag/int_aw_mode2_gradz_power_da_dt_discrete") +
      pkg->Param<double>("diag/int_aw_mode3_gradz_power_da_dt_discrete");
  return coeff * (cz_exact + aw_dz_work);
}

Real BulkEMEnergyIntegral(MeshData<Real> *md) {
  return BulkEMEnergyLegacyIntegral(md) - BulkEMEnergyZBlockCorrectionAccumulatorHst(md);
}

Real BulkEMEnergyHst(MeshData<Real> *md) { return BulkEMEnergyIntegral(md); }

Real BulkEMEnergyLegacyHst(MeshData<Real> *md) { return BulkEMEnergyLegacyIntegral(md); }

Real BulkEMEnergyZBlockCorrectionHst(MeshData<Real> *md) {
  return BulkEMEnergyZBlockCorrectionAccumulatorHst(md);
}
...
Real BulkEMEnergyDiscreteAwDzModes12Hst(MeshData<Real> *md) {
  return BulkEMEnergyLegacyIntegral(md) -
         BraneMixedIntegral(md, BraneMixedQuantity::MixedCz2) +
         BulkEMEnergyDiscreteAwDzIntegral(md, 1, 2);
}

Real BulkEMEnergyDiscreteAwDzModes0123Hst(MeshData<Real> *md) {
  return BulkEMEnergyLegacyIntegral(md) -
         BraneMixedIntegral(md, BraneMixedQuantity::MixedCz2) +
         BulkEMEnergyDiscreteAwDzIntegral(md, 0, 3);
}
...
void RegisterDiagnostics(parthenon::StateDescriptor *pkg) {
  ...
  pkg->AddParam<double>("diag/int_aw_mode2_gradz_power_mix_w0_local_dz_signed_mode2", 0.0,
                        true);
  pkg->AddParam<double>("diag/int_aw_mode2_gradz_power_mix_w0_local_gradient_discrete", 0.0,
                        true);
  ...
  pkg->AddParam<double>("diag/int_aw_gradx_power_pi_drive_discrete_sum", 0.0, true);
  ...
  pkg->AddParam<double>("diag/int_aw_gradx_work_exact_node_sum", 0.0, true);
  pkg->AddParam<double>("diag/int_aw_gradz_work_exact_node_sum", 0.0, true);
  ...
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum, ResponseLambdaDynamicMixPiAbsAccumulatorHst,
  ...
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum,
      AwMode1GradzPowerMixW0LocalGradientDiscreteAccumulatorHst,
      "m4d_int_aw_mode1_gradz_power_mix_w0_local_gradient_discrete"));
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum,
  ...
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum,
      AwMode0GradzEnergyDeltaQuadraticDiscreteAccumulatorHst,
  ...
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum,
      AwMode1GradzEnergyDeltaQuadraticDiscreteAccumulatorHst,
  ...
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum,
      AwMode2GradzPowerMixW0LocalGradientDiscreteAccumulatorHst,
      "m4d_int_aw_mode2_gradz_power_mix_w0_local_gradient_discrete"));
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum,
      AwMode2GradzPowerMixW0LocalDzDiscreteAccumulatorHst,
      "m4d_int_aw_mode2_gradz_power_mix_w0_local_dz_discrete"));
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum, AwMode2GradzPowerPiDriveDiscreteAccumulatorHst,
      "m4d_int_aw_mode2_gradz_power_pi_drive_discrete"));
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
  ...
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum,
      AwMode2GradzEnergyDeltaQuadraticDiscreteAccumulatorHst,
  ...
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum, AwGradxPowerPiDriveDiscreteSumAccumulatorHst,
      "m4d_int_aw_gradx_power_pi_drive_discrete_sum"));
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum, AwGradzPowerPiDriveDiscreteSumAccumulatorHst,
      "m4d_int_aw_gradz_power_pi_drive_discrete_sum"));
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum, AwGradxEnergyDeltaExactDiscreteSumAccumulatorHst,
      "m4d_int_aw_gradx_energy_delta_exact_discrete_sum"));
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum,
  ...
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum, AwGradxWorkExactNodeSumAccumulatorHst,
      "m4d_int_aw_gradx_work_exact_node_sum"));
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum, AwGradzWorkExactNodeSumAccumulatorHst,
  ...
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum,
      AwGradzPowerMixW0LocalGradientDiscreteSumAccumulatorHst,
      "m4d_int_aw_gradz_power_mix_w0_local_gradient_discrete_sum"));
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum,
  ...
  hst_vars.emplace_back(parthenon::HistoryOutputVar(
      parthenon::UserHistoryOperation::sum,
      AwMode3GradzEnergyDeltaQuadraticDiscreteAccumulatorHst,
  ...
  hst_vars.emplace_back(parthenon::HistoryOutputVar(parthenon::UserHistoryOperation::sum,
                                                    ...
                                                    "m4d_em_u_bulk"));
  hst_vars.emplace_back(parthenon::HistoryOutputVar(parthenon::UserHistoryOperation::sum,
                                                    BulkEMEnergyLegacyHst,
                                                    "m4d_em_u_bulk_legacy"));
  hst_vars.emplace_back(parthenon::HistoryOutputVar(parthenon::UserHistoryOperation::sum,
                                                    BulkEMEnergyZBlockCorrectionHst,
