#!/usr/bin/env python3
"""Summarize per-mode A_w gradient-power proxies against diagonal d_z a_w energy drift."""
...
def main():
    ...
    if not rows:
        raise SystemExit("No A_w gradient-power rows were computed.")
    ...
    with out_md.open("w", encoding="utf-8") as f:
        f.write("# Step-165 A_w Gradient-Power Audit\n\n")
