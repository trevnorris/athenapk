...
OUTPUT_ROOT="/projects/fluid-engine/out/step213_postpatch_sub010_threshold_local"
...
usage() {
  cat <<'USAGE'
Run Step-213 sub-amp010 threshold sweep for the post-patch 2pi forcing branch.
USAGE
}
...
run_case "patched_omega_2pi_amp0025" "3.125e-4" "1.875e-4"
run_case "patched_omega_2pi_amp0050" "6.25e-4" "3.75e-4"
run_case "patched_omega_2pi_amp0075" "9.375e-4" "5.625e-4"
run_case "patched_omega_2pi_amp0090" "1.125e-3" "6.75e-4"
...
python3 "${REPO_ROOT}/scripts/summarize_step213_postpatch_sub010_threshold_sweep.py" \
  --glob "${OUTPUT_ROOT}/*" \
  --summary-csv "${OUTPUT_ROOT}_summary.csv" \
  --phase2-csv "${OUTPUT_ROOT}_phase2.csv" \
