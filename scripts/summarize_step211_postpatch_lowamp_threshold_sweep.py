#!/usr/bin/env python3
"""Summarize Step-211 near-threshold low-amplitude forcing sweep."""
...
def main():
    ...
    if not rows:
        raise SystemExit("No Step-211 rows computed.")
    ...
    with out_md.open("w", encoding="utf-8") as f:
        f.write("# Step-211 Post-Patch Low-Amplitude Threshold Sweep\n\n")
