...
OUTPUT_ROOT="/projects/fluid-engine/out/step133_controlled_identity_probe_local"
...
usage() {
  cat <<'USAGE'
Run Step-133 controlled identity-basis probe.

Goal:
  Test whether hard controlled-limit identity basis removes the persistent
  perturbative controlled runaway, compared with legacy hard-limit behavior.

Usage:
  ./scripts/run_step133_controlled_identity_probe.sh [options]
...
echo ""
echo "Step-133 controlled identity probe complete."
