...
OUTPUT_ROOT="/projects/fluid-engine/out/step212_postpatch_sub040_threshold_local"
...
usage() {
  cat <<'USAGE'
Run Step-212 sub-amp040 threshold sweep for the post-patch 2pi forcing branch.
USAGE
}
...
run_case "patched_omega_2pi_amp010" "1.25e-3" "7.5e-4"
run_case "patched_omega_2pi_amp020" "2.5e-3" "1.5e-3"
run_case "patched_omega_2pi_amp030" "3.75e-3" "2.25e-3"
run_case "patched_omega_2pi_amp035" "4.375e-3" "2.625e-3"
...
python3 "${REPO_ROOT}/scripts/summarize_step212_postpatch_sub040_threshold_sweep.py" \
  --glob "${OUTPUT_ROOT}/*" \
  --summary-csv "${OUTPUT_ROOT}_summary.csv" \
  --phase2-csv "${OUTPUT_ROOT}_phase2.csv" \
