...
OUTPUT_ROOT="/projects/fluid-engine/out/step134_controlled_vacuum_ab_local"
...
usage() {
  cat <<'USAGE'
Run Step-134 controlled-limit vacuum Maxwell A/B.

Goal:
  Isolate EM-side controlled-limit behavior with Nw=1 in a vacuum-like pulse
  setup and compare:
    - no hard controlled limit
    - hard controlled legacy basis
    - hard controlled identity mode-0 basis

Usage:
  ./scripts/run_step134_controlled_vacuum_ab.sh [options]
...
echo ""
echo "Step-134 controlled vacuum A/B complete."
