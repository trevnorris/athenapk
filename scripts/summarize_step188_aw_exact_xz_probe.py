#!/usr/bin/env python3
"""Compare exact discrete A_w,x and A_w,z energy increments against the bulk residual."""
...
def main():
    ...
    for case_dir in case_dirs:
        ...
        x_exact = select_window(
            t_r,
            derivative_series(times, cols["m4d_int_aw_gradx_energy_delta_exact_discrete_sum"])[1],
            t_lo,
            end,
            include_right=True,
        )
    ...
    if not rows:
        raise SystemExit("No Step-188 rows were computed.")
    ...
    with out_md.open("w", encoding="utf-8") as f:
        f.write("# Step-188 A_w Exact X/Z Probe\n\n")
