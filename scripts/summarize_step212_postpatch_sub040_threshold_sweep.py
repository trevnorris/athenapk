#!/usr/bin/env python3
"""Summarize Step-212 near-threshold sub-amp040 forcing sweep."""
...
def main():
    ...
    if not rows:
        raise SystemExit("No Step-212 rows computed.")
    ...
    with out_md.open("w", encoding="utf-8") as f:
        f.write("# Step-212 Post-Patch Low-Amplitude Threshold Sweep\n\n")
