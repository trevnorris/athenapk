#!/usr/bin/env python3
"""Summarize Step-214 near-threshold micro-threshold forcing sweep."""
...
def main():
    ...
    if not rows:
        raise SystemExit("No Step-214 rows computed.")
    ...
    with out_md.open("w", encoding="utf-8") as f:
        f.write("# Step-214 Post-Patch Low-Amplitude Threshold Sweep\n\n")
