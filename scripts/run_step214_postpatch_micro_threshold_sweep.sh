...
OUTPUT_ROOT="/projects/fluid-engine/out/step214_postpatch_micro_threshold_local"
...
usage() {
  cat <<'USAGE'
Run Step-214 micro-threshold sweep below amp0025 for the post-patch 2pi forcing branch.
USAGE
}
...
run_case "patched_omega_2pi_amp0005" "6.25e-5" "3.75e-5"
run_case "patched_omega_2pi_amp0010" "1.25e-4" "7.5e-5"
run_case "patched_omega_2pi_amp0015" "1.875e-4" "1.125e-4"
run_case "patched_omega_2pi_amp0020" "2.5e-4" "1.5e-4"
...
python3 "${REPO_ROOT}/scripts/summarize_step214_postpatch_micro_threshold_sweep.py" \
  --glob "${OUTPUT_ROOT}/*" \
  --summary-csv "${OUTPUT_ROOT}_summary.csv" \
  --phase2-csv "${OUTPUT_ROOT}_phase2.csv" \
